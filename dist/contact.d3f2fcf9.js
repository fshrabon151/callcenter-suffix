...
var isEmpty = function isEmpty(value) {
  if (_typeof(value) === undefined || value === null || value === undefined) {
    return true;
  }
...
form.addEventListener("submit", function (e) {
  e.preventDefault();
  var formDataElements = new FormData(this); // Create an array to hold the name/value pairs

  var pairs = []; // Add each name/value pair to the array

  var _iterator = _createForOfIteratorHelper(formDataElements),
      _step;
  ...
  var formData = Object.assign.apply(Object, [{}].concat(_toConsumableArray(pairs.map(function (item) {
    return _defineProperty({}, item.name, item.value);
  }))));

  if (!isEmpty(formData["g-recaptcha-response"])) {
    submitBtn.innerText = "Sending...";
    submitBtn.setAttribute("disabled", true);
    emailjs.send("yourName", "YourPAssword", formData).then(function () {
